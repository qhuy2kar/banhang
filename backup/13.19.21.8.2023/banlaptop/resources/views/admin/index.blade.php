  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="row">
      <div class="col-md-12 d-flex justify-content-between">
        <a href="#" class="btn border border-light text-white">Xin chào: <strong>{{ Auth::user()->name }}</strong></a>
        <a href="{{ route('admin.logout') }}" class="btn btn-danger ml-2 float-end">Đăng Xuất</a>
      </div>
    </div>
  </nav>
