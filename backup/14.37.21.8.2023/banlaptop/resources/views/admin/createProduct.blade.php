                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ten" class="form-control" placeholder="Nhap tên sản phẩm">
                            </div>
                            <div class="form-group">
                                <strong>Mô tả</strong>
                                <input type="text" name="mota" class="form-control" placeholder="Nhap mô tả">
                            </div>
                            <div class="form-group">
                                <strong>Giá</strong>
                                <input type="text" name="gia" class="form-control" placeholder="Nhap giá sản phẩm">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <strong>Số lượng</strong>
                                <input type="text" name="soluong" class="form-control" placeholder="Nhap so lượng sản phẩm">
